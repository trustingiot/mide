...
public class LinearLeastSquaresSolver {
	...
	public RealVector solve(boolean debugInfo) {
		...
		// TODO: which reference position should be used? currently using postion and
		// distance in index 0.
		...
		// reference point is function.getPositions()[0], with distance
		// function.getDistances()[0]
